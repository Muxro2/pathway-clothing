...
<div className="flex flex-col gap-4">
			...
			<button className="p-4 text-[20px] font-big-shoulders tracking-[0.1em] leading-none font-semibold underline uppercase">Login</button>
			<p className="text-[20px] font-big-shoulders text-center tracking-[0.1em] leading-none font-semibold uppercase">or</p>
				...
				<button className="p-4 text-[20px] font-big-shoulders tracking-[0.1em] leading-none font-semibold underline uppercase">Sign Up</button>
</div>
